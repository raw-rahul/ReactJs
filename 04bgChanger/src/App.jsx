...
{/* style={{background: "black", color: "white"}} */}
    <div className={`fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2 border border-5px ${color === "black" ? 'bg-white' : ' bg-black'}`}>
      <div 
      ...
      >
        ...
        className='outline-none px-4 py-1 rounded-full text-black shadow-lg' style={{background: 'white'}}>White</button>
